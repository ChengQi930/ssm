...
Ext.define('Johe.util.MD5', {
   ...
   */
  hex_md5: function (s) {
    var str1 = this.str2rstr_utf8(s);
    var str2 = this.rstr_md5(str1);
    var str3 = this.rstr2hex(str2);
    return str3;
  ...
  any_hmac_md5: function (k, d, e) {
    return this.rstr2any(rstr_hmac_md5(this.str2rstr_utf8(k), this.str2rstr_utf8(d)), e);
  },
