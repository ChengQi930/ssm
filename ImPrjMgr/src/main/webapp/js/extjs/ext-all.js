			...
			if (a(p)) {
				...
				for (q in n) {
					...
					if (!r.filterOptRe.test(q)) {
						r.addListener(q, v.fn || v, v.scope || n.scope,
								v.fn ? v : n)
					}
				}
			} else {
...
Ext.Element
		.addMethods(function() {
			var h = {}, y = /(-[a-z])/gi, b = {}, s = document.defaultView, u = Ext.isIE ? "styleFloat"
			...
			return {
				...
				getHeight : function(H) {
					var G = this, J = G.dom, I = Ext.isIE
							&& G.isStyle("display", "none"), F = r.max(
				...
				getWidth : function(G) {
					var H = this, J = H.dom, I = Ext.isIE
							&& H.isStyle("display", "none"), F = r.max(
	...
	Ext.Fx = {
					...
					function() {
						...
						J = p(H)
								.switchStatements(
										...
										R,
										{
											t : [ E, N, M.width, 0, z, z, n, l,
													z, G, z ],
											l : [ E, N, 0, M.height, z, z, m,
													s, L, z, z ],
											r : [ E, N, M.width, M.height, j,
													M.right, n, s, z, z, O ],
											b : [ E, N, M.width, M.height, h,
													M.bottom, n, s, z, G, O ],
											tl : [ E, N, 0, 0, z, z, m, l, L,
													G, O ],
											bl : [ E, N, 0, 0, h,
													M.y + M.height, m, s, L, G,
													O ],
											br : [ E, N, 0, 0, a,
													[ M.right, M.bottom ], n,
													s, L, G, O ],
		...
		highlight : function(E, I) {
			...
			G.queueFx(I, function() {
				...
				arguments.callee.anim = p(H).fxanim(D, I, "color", 1, "easeIn",
						J)
			});
			return G
		},
				...
				Ext.layout.BoxLayout,
				{
					...
					calculateChildBoxes : function(x, e) {
						var k = x.length, u = this.padding, z = u.top, p = u.left, q = z
								+ u.bottom, a = p + u.right, y = e.width
								- this.scrollOffset, v = e.height, B = Math
						...
						for (C = 0; C < k; C++) {
							...
							case "stretch":
								E = B - H;
								s.width = E.constrain(h.minHeight || 0,
										h.maxWidth || 1000000);
								s.dirtySize = true;
								break;
							case "stretchmax":
				...
				Ext.layout.BoxLayout,
				{
					...
					calculateChildBoxes : function(A, e) {
						var n = A.length, y = this.padding, D = y.top, r = y.left, s = D
								+ y.bottom, a = r + y.right, C = e.width
								- this.scrollOffset, z = e.height, h = Math
				...
				Ext.data.JsonReader,
				{
					readRecords : function(r) {
						...
						var l = this.meta, d = l ? Ext.num(l.idIndex, l.id)
								: null, b = this.recordType, q = b.prototype.fields, A = [], e = true, g;
		...
		.extend(
				Ext.grid.GridView,
				{
					...
					doRender : function(c, h, q, a, p, s) {
						...
						var A = this.getGroupField(), o = this.cm
								.findColumnIndex(A), x, j = "width:"
						...
						for (u = 0, v = z.length; u < v; u++) {
							...
							y[y.length] = Ext.grid.GroupingView.superclass.doRender
									.call(this, c, x.rs, q, x.startRow, p, s);
